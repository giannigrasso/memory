...
public class LoadConfirmationProviderTui implements UserConfirmationProvider {
    ...
    public LoadConfirmationProviderTui(Scanner input, TranslationProvider translator) {
        this.input = input;
    ...
    private void applyTranslations(TranslationProvider translator) {
        this.title = this.translator.translate("label.confirm_load.title");
        final String translatedText = this.translator.translate("label.confirm_load.text");
